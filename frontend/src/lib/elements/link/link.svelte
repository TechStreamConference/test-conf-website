<script lang="ts">
	...
	const { children, href, aria_label, target = DEFAULT_LINK_TARGET, rel: nel_name, ...rest }: Props = $props();
</script>

<!-- eslint-disable-next-line svelte/no-navigation-without-resolve -->
<a {href} {target} aria-label={aria_label} rel={[nel_name, get_rel(target)]} {...rest}>
	{@render children()}
</a>

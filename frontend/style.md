...
interface Props extends Omit<HTMLInputAttributes, | "specificvalue" | "unoptional"> { // props can also be omitted to remove them from the component.
...
div {
    ...
    /* animations */
    transition: font-size var(--transition-duration-fast),
